  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        <div>
          <label htmlFor="link-popover-url" className="block text-xs text-ink-muted mb-1">
            URL
          </label>
          <input
            id="link-popover-url"
      ...
      <div className="flex items-center justify-between mt-4 pt-3 border-t border-line">
        <button
          onClick={handleOpen}
          disabled={!url}
          className="flex items-center gap-1 px-2 py-1 text-xs text-ink-muted hover:text-[var(--rmd-accent)] disabled:opacity-50 disabled:cursor-not-allowed"
        >
